...
-- 受注ヘッダ（4月の受注: J202404001 / J202404002）
INSERT INTO TBL_JUTYU_HEADER (juno, judt, jutr, junk, just, jusm, jurm, jucb, juub) VALUES
  ('J202404001', '2026-04-10', 'T0101', '2026-04-20', '1', 1210.00, 'テスト受注1', '12345', '12345'),
  ('J202404002', '2026-04-15', 'T0102', '2026-04-25', '1', 1360.00, 'テスト受注2', '12345', '12345');

-- 受注明細（J202404001: 鉛筆10本 + ボールペン5本）
INSERT INTO TBL_JUTYU_DETAIL (juno, juln, prdcd, juup, juqt, juam, dfcb, dfub) VALUES
  ('J202404001', 1, 'P0001',  80, 10,  800.00, '12345', '12345'),
  ('J202404001', 2, 'P0002', 150,  5,  750.00, '12345', '12345');

-- 受注明細（J202404002: ノート2冊 + クリアファイル3枚）
INSERT INTO TBL_JUTYU_DETAIL (juno, juln, prdcd, juup, juqt, juam, dfcb, dfub) VALUES
  ('J202404002', 1, 'P0003', 280, 2, 560.00, '12345', '12345'),
  ('J202404002', 2, 'P0004',  40, 3, 120.00, '12345', '12345');

-- =====================================================================
-- サンプル発注データ
-- =====================================================================

-- 発注ヘッダ（4月の発注: H202404001 / H202404002）
INSERT INTO TBL_HATYU_HEADER (hano, hadt, hatr, hank, hast, hasm, harm, hacb, haub) VALUES
  ('H202404001', '2026-04-05', 'T0001', '2026-04-12', '1', 7200.00, 'テスト発注1', '22345', '22345'),
  ('H202404002', '2026-04-08', 'T0002', '2026-04-18', '1', 3600.00, 'テスト発注2', '22345', '22345');

-- 発注明細（H202404001: 鉛筆50本 + ボールペン30本）
INSERT INTO TBL_HATYU_DETAIL (hano, haln, prdcd, haup, haqt, haiq, haam, dhcb, dhub) VALUES
  ('H202404001', 1, 'P0001',  80, 50, 0, 4000.00, '22345', '22345'),
  ('H202404001', 2, 'P0002', 150, 30, 0, 4500.00, '22345', '22345');

-- 発注明細（H202404002: ノート20冊 + クリアファイル40枚）
INSERT INTO TBL_HATYU_DETAIL (hano, haln, prdcd, haup, haqt, haiq, haam, dhcb, dhub) VALUES
  ('H202404002', 1, 'P0003', 280, 20, 0, 5600.00, '22345', '22345'),
  ('H202404002', 2, 'P0004',  40, 40, 0, 1600.00, '22345', '22345');

-- =====================================================================
-- サンプル入荷データ
-- =====================================================================

-- 入荷実績（H202404001 の発注に対して一部入荷）
INSERT INTO TBL_NYUKA (hano, haln, nydt, nyqt, nycb, nyub) VALUES
  ('H202404001', 1, '2026-04-12', 50, '22345', '22345'),
  ('H202404001', 2, '2026-04-12', 30, '22345', '22345');

-- 発注明細の入荷済数を更新
UPDATE TBL_HATYU_DETAIL SET haiq = 50 WHERE hano = 'H202404001' AND haln = 1;
UPDATE TBL_HATYU_DETAIL SET haiq = 30 WHERE hano = 'H202404001' AND haln = 2;

-- 発注ステータスを「完了」に更新
UPDATE TBL_HATYU_HEADER SET hast = '3' WHERE hano = 'H202404001';

-- =====================================================================
-- サンプル出荷データ
-- =====================================================================

-- 出荷実績（J202404001 の受注に対して出荷）
INSERT INTO TBL_SYUKKA (juno, juln, sydt, syqt, sycr, sytn, sycb, syub) VALUES
  ('J202404001', 1, '2026-04-18', 10, 'ヤマト運輸', '1234567890', '33345', '33345'),
  ('J202404001', 2, '2026-04-18',  5, 'ヤマト運輸', '1234567891', '33345', '33345');

-- 受注ステータスを「完了」に更新
UPDATE TBL_JUTYU_HEADER SET just = '3' WHERE juno = 'J202404001';
